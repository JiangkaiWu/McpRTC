    ...
    try:
        ...
        if "function_call" in intent_data:
            ...
            def process_function_call():
                conn.dialogue.put(Message(role="user", content_type="text",text_content=original_text))
                ...
                if result:
                    if result.action == Action.RESPONSE:  # 直接回复前端
                        ...
                        text = result.result
                        conn.dialogue.put(Message(role="tool", content_type="text", text_content=text))
...
def speak_txt(conn, text):
    ...
    conn.dialogue.put(Message(role="assistant", content_type="text", text_content=text))
