...
class Dialogue:
    ...
    def getMessages(self, m: Message, dialogue):
        if m.tool_calls is not None:
            ...
            elif m.content_type == "video_data":
                dialogue.append({
                    "role": m.role,
                    "content": [
                        {
    ...
    def update_system_message(self, new_content: str):
        ...
        if system_msg:
            ...
            self.put(Message(role="system", content_type="text",text_content=new_content))
